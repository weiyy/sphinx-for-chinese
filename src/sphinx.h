//
// $Id: sphinx.h 4307M 2013-11-09 08:19:20Z (local) $
//
...
#define SPHINX_BANNER			"Sphinx-for-Chinese " SPHINX_VERSION "\nCopyright (c) 2008-2013 (http://www.sphinx-search.com/)\n\n"
...
public:
	...
	uint64_t m_iWeight;		///< my computed weight
